...
import { resetQuizState,clearQuizData } from '../redux/Slices/PlayQuizSlice';
...
const ResultModel = ({ score, total }) => {
  ...
  return (
   <div className=''>
     <div className='fixed p-2  inset-0 bg-black bg-opacity-50 modal-zIndex flex items-center justify-center'>
