        ...
        <div className="flex">
          ...
          <div className="w-full lg:w-1/2 p-8">
            <div className="max-w-md mx-auto">
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-gray-400">Join our community of quiz enthusiasts</p>
              </div>
              ...
              <p className="mt-4 text-center text-xs text-gray-400">
                ...
                <button 
                 ...
                 className="text-purple-400 hover:text-purple-300">Sign in</button>
              </p>
            </div>
          </div>
          ...
          <div className="hidden lg:block lg:w-1/2 bg-gradient-to-br from-purple-900/20 to-purple-900/5 relative">
            ...
            <div className="absolute bottom-0 left-0 p-8 max-w-xl">
              <h2 className="text-2xl font-bold text-white mb-2">Join the Quiz Revolution</h2>
              <p className="text-sm text-gray-200">Create, share, and challenge yourself with our growing community of quiz enthusiasts.</p>
            </div>
          </div>
        </div>
      </div>
