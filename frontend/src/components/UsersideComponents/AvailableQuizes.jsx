...
const AvailableQuizes = () => {
  ...
  // Helper function to get quizzes by difficulty for a category
  ...
  // Get popular quizzes for a specific category
  ...
  // Helper function to render a carousel section only if it has quizzes
  ...
  return (
    <div className="relative ">
      ...
      <div className="p-4">
        ...
        {/* Show message if no quizzes are available for the selected category */}
