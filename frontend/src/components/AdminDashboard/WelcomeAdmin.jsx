...
const WelcomeAdmin = () => {
    ...
    return (
        <div className='   block md:flex justify-start md:justify-center items-center h-full'>
            <div className=" ">
                <div className=" bg-gradient-to-r   from-purple-600 to-purple-800 rounded-2xl p-3 md:p-5 shadow-lg
                space-y-6">
