...
import { User, Mail, Lock, Edit, Camera, Save, AlertTriangle, FileText } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 md:p-4  ">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-6 md:p-8">
        <div className="flex justify-between items-center mb-8">
          <h1 className=" text-lg sm:text-2xl  font-bold text-purple-600">Profile Settings</h1>
          <button
            onClick={toggleEdit}
            className="flex items-center whitespace-nowrap gap-2 px-4 py-2 text-sm rounded-md bg-purple-50 text-purple-600 hover:bg-purple-100 transition-colors"
          >
